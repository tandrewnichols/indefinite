import { check, list } from './irregular-words';
...
const checkForIrregulars = part => [ null, 's', 'es', 'ed' ].reduce((memo, ending) => memo || check(part, ending), false);
...
indefinite.irregularWords = list;
